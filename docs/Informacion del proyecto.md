...
Descripción
NatureIn es una plataforma web educativa interactiva diseñada para fomentar la conciencia ambiental en estudiantes de secundaria (primero) en Tingo María, Perú. Enfocada en flora y fauna local, combina aprendizaje lúdico con gamificación y recursos validados científicamente. Refocalizada para simplicidad: sin aulas ni roles docentes para creación de fichas (usar APIs externas). Incluye chatbot adaptativo y gamificación vía Educaplay.
...
Excluye: Módulos de aulas/clases, creación manual de fichas por docentes, roles complejos de instituciones.
